...
class TestUserEndpoints:
    ...
    def test_list_users_success(self, mock_get_users):
        ...
        mock_users = [
            ...
            MockUser(id=test_uuid2, email="user2@example.com", company_name="Company Two", 
                     hashed_password="hashed_password_456", is_active=True,
                     created_at=test_datetime, updated_at=test_datetime, roles=[])
        ]
    ...
    def test_get_user_success(self, mock_get_user):
        ...
        mock_get_user.assert_called_once_with(mock_get_user.call_args[0][0], str(test_uuid))
    ...
    def test_update_user_success(self, mock_update_user):
        ...
        updated_user = MockUser(**{**sample_user_data, **sample_user_update, "roles": []})
    ...
    def test_delete_user_success(self, mock_delete_user):
        ...
        mock_delete_user.assert_called_once_with(mock_delete_user.call_args[0][0], str(test_uuid))
...
class TestUserEndpointsPerformance:
    ...
    def test_list_users_performance(self, mock_get_users):
        ...
        large_user_list = [MockUser(id=uuid.uuid4(), email=f"user{i}@example.com", 
                                   company_name=f"Company {i}", hashed_password=f"hash{i}",
                                   is_active=True, created_at=test_datetime, 
                                   updated_at=test_datetime, roles=[]) for i in range(1000)]
